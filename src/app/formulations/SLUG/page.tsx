                        ...
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap gap-1">{m.activeCompounds.map((c) => (
                              <span key={c.name} className="text-xs px-1.5 py-0.5" style={{ background: 'rgba(201,140,36,0.06)', border: '1px solid rgba(201,140,36,0.15)', fontFamily: 'var(--font-ibm)' }}>{c.name}</span>
                            ))}</div>
                          </div>
                          <div>
